...
const color = ref(LESSON_OBJECT_DEFAULTS.physicsDataPlot.color);
const xLabel = ref(LESSON_OBJECT_DEFAULTS.physicsDataPlot.xLabel);
const yLabel = ref(LESSON_OBJECT_DEFAULTS.physicsDataPlot.yLabel);
const error = ref('');
const windowWidth = computed(() => window.innerWidth);
const initialX = computed(() => Math.max(80, windowWidth.value <= 1024 ? windowWidth.value - 380 : windowWidth.value - 380));
const initialY = computed(() => (windowWidth.value <= 1024 ? 290 : 120));

...
import { RESOURCE_MESSAGE_PL, type ResourceMessageKey } from './resourceGovernor';
...
const ARTIFACT_SPECIFIC_MESSAGE_PL: Record<Exclude<ArtifactMessageKey, ResourceMessageKey>, string> = {
